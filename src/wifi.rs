...
/// Established a connection to the configured Wi-Fi network.
/// Automatically restarts the hardware if the connection fails repeatedly.
pub async fn connect_wifi(
    ...
    // peripherals.modem abstracts hardware differences between ESP32 variants
    ...
    loop {
        ...
        if attempts >= MAX_RETRIES {
            error!("FATAL: WiFi failed after {} attempts.", MAX_RETRIES);
            info!("Restarting hardware in 3 seconds...");
